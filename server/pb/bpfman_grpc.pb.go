...
// UnimplementedBpfmanServer must be embedded to have
...
func (UnimplementedBpfmanServer) PullBytecode(context.Context, *PullBytecodeRequest) (*PullBytecodeResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method PullBytecode not implemented")
}
...
func RegisterBpfmanServer(s grpc.ServiceRegistrar, srv BpfmanServer) {
	// If the following call panics, it indicates UnimplementedBpfmanServer was
