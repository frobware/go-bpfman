...
func TestDispatcherLinkPath(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got := dispatcher.DispatcherLinkPath(tt.dispType, tt.nsid, tt.ifindex)
			if got != tt.want {
...
func TestDispatcherRevisionDir(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got := dispatcher.DispatcherRevisionDir(tt.dispType, tt.nsid, tt.ifindex, tt.revision)
			if got != tt.want {
...
func TestTypeDir(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got := dispatcher.TypeDir(tt.dispType)
			if got != tt.want {
...
func TestPathsEndToEnd(t *testing.T) {
	...
	linkPath := dispatcher.DispatcherLinkPath(dispatcher.DispatcherTypeXDP, nsid, ifindex)
	...
	revDir := dispatcher.DispatcherRevisionDir(dispatcher.DispatcherTypeXDP, nsid, ifindex, revision)
